        ...
        await _firestoreService.addStudent(
          widget.batchId,
          {
            ...
            'macAddress': _macAddressController.text.trim().isEmpty 
                ? null 
                : _macAddressController.text.toUpperCase().trim(),
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                helperText: 'For automatic attendance via ESP32',
              ),
              validator: (value) {
                if (value != null && value.isNotEmpty) {
                  // Basic MAC address validation (accepts different formats)
                  final macRegex = RegExp(r'^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$');
                  if (!macRegex.hasMatch(value)) {
                    return 'Please enter valid MAC address (AA:BB:CC:DD:EE:FF)';
                  }
                }
                return null;
              },
